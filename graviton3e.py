...
def graviton3e(pmu, args):
    ...
    if args.noheader != True:
        ...
        print(f"  ll_cache_read_mpki, {ll_cache_read_mpki:.2f}")
        ...
        print(f"  ll_cache_read_miss_ratio, {ll_cache_read_miss_ratio:.2f}")
    else:
        print()
        ...
        print(f"{ll_cache_read_miss_ratio:.2f}")
